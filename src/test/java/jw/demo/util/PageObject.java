...
public abstract class PageObject extends Driver {
    ...
    protected PageObject() {
        ...
        this.wait = new WebDriverWait(webDriver, SHORT.waitTime());
    }
    ...
    public boolean checkPageTitle(String title) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.titleIs(title));
    }
    ...
    public boolean checkPageTitleContains(String title) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.titleContains(title));
    }
    ...
    public boolean checkPageUrlToBe(String url) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.urlToBe(url));
    }
    ...
    public boolean checkPageUrlContains(String fraction) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.urlContains(fraction));
    }
    ...
    public boolean checkPageUrlMatches(String regex) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.urlMatches(regex));
    }
    ...
    public boolean textToBePresentInElement(WebElement element, String text) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.textToBePresentInElement(element, text));
    }
    ...
    public boolean textToBePresentInElementLocated(final By by, final String text) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.textToBePresentInElementLocated(by, text));
    }
    ...
    public boolean textToBePresentInElementValue(final WebElement element, final String text) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.textToBePresentInElementValue(element, text));
    }
    ...
    public boolean textToBePresentInElementValue(final By by, final String text) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.textToBePresentInElementValue(by, text));
    }
    ...
    public WebDriver frameToBeAvailableAndSwitchToIt(final String frameLocator) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameLocator));
    }
    ...
    public WebDriver frameToBeAvailableAndSwitchToIt(final By by) {
        return new WebDriverWait(getWebDriver(), SHORT.waitTime()).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(by));
    }
    ...
    public boolean invisibilityOfElementLocated(By by) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.invisibilityOfElementLocated(by));
    }
    ...
    public boolean invisibilityOfElementWithText(final By by, final String text) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.invisibilityOfElementWithText(by, text));
    }
    ...
    public WebElement elementToBeClickable(By by) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementToBeClickable(by));
    }
    ...
    public WebElement elementToBeClickable(final WebElement element) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementToBeClickable(element));
    }
    ...
    public boolean stalenessOf(final WebElement element) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.stalenessOf(element));
    }
    ...
    public boolean elementToBeSelected(final By by) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementToBeSelected(by));
    }
    ...
    public boolean elementToBeSelected(final WebElement element) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementToBeSelected(element));
    }
    ...
    public boolean elementSelectionStateToBe(final WebElement element, final boolean selected) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementSelectionStateToBe(element, selected));
    }
    ...
    public boolean elementSelectionStateToBe(final By by,
        ...
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.elementSelectionStateToBe(by, selected));
    }

    public void waitForAlert() {
        (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.alertIsPresent());
    }
    ...
    public List<WebElement> visibilityOfAllElementsLocatedBy(final By by) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(by));
    }
    ...
    public List<WebElement> visibilityOfAllElements(final List<WebElement> elements) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.visibilityOfAllElements(elements));
    }
    ...
    public List<WebElement> presenceOfAllElementsLocatedBy(final By by) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.presenceOfAllElementsLocatedBy(by));
    }
    ...
    public WebElement visibilityOf(final WebElement element) {
        return (new WebDriverWait(getWebDriver(), SHORT.waitTime())).until(ExpectedConditions.visibilityOf(element));
    }
